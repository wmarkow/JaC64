...
public class Keyboard {
    ...
    public static final char[][] KEYMAPS = new char[][] { { 's', 'v', // Keymap for language "sv"
            ';', ';', '\'', '\'', '[', '[', '`', '`', '\\', (char) 222, '/', '-', ']', (char) 135, '-',
            (char) KeyEvent.VK_PLUS, '=', (char) 129 },
    ...
    int keytableDef[][] = new int[][] { { 'A', 1, 2, 0 }, { 'B', 3, 4, 0 }, { 'C', 2, 4, 0 }, { 'D', 2, 2, 0 },
            { 'E', 1, 6, 0 }, { 'F', 2, 5, 0 }, { 'G', 3, 2, 0 }, { 'H', 3, 5, 0 }, { 'I', 4, 1, 0 }, { 'J', 4, 2, 0 },
            { 'K', 4, 5, 0 }, { 'L', 5, 2, 0 }, { 'M', 4, 4, 0 }, { 'N', 4, 7, 0 }, { 'O', 4, 6, 0 }, { 'P', 5, 1, 0 },
            { 'Q', 7, 6, 0 }, { 'R', 2, 1, 0 }, { 'S', 1, 5, 0 }, { 'T', 2, 6, 0 }, { 'U', 3, 6, 0 }, { 'V', 3, 7, 0 },
            { 'W', 1, 1, 0 }, { 'X', 2, 7, 0 }, { 'Y', 3, 1, 0 }, { 'Z', 1, 4, 0 }, { '0', 4, 3, 0 }, { '1', 7, 0, 0 },
            { '2', 7, 3, 0 }, { '3', 1, 0, 0 }, { '4', 1, 3, 0 }, { '5', 2, 0, 0 }, { '6', 2, 3, 0 }, { '7', 3, 0, 0 },
            { '8', 3, 3, 0 }, { '9', 4, 0, 0 }, { '\n', 0, 1, 0 }, { KeyEvent.VK_ENTER, 0, 1, 0 }, { ' ', 7, 4, 0 },
            { ',', 5, 7, 0 }, { '.', 5, 4, 0 },
            // = on the \ pos.
            { '\\', 6, 5, 0 },
            // This is actually colon on the C64 ;-)
            { ';', 5, 5, 0 }, { '-', 5, 0, 0 }, // Actually + on the C64... (- => +)
            // {'-', 5, 3, 0 },
            { '=', 5, 3, 0 }, // Actually - on the C64... (= => -)
            { '`', 7, 1, 0 },
            // This is semi-colon on the C64
            { '\'', 6, 2, 0 }, { KeyEvent.VK_SUBTRACT, 5, 3, 0 }, { '[', 5, 6, 0 }, { ']', 6, 1, 0 },
            { KeyEvent.VK_ESCAPE, 7, 1, 0 }, { '/', 6, 7, 0 }, { KeyEvent.VK_DIVIDE, 6, 7, 0 },
            // will be mapped to an auto shift /
            { '?', 6, 7, AUTO_SHIFT }, { KeyEvent.VK_DELETE, 0, 0, 0 }, { KeyEvent.VK_BACK_SPACE, 0, 0, 0 },
            // LEFT SHIFT
            ...
            // Break
            { 19, 7, 7, 0 }, { KeyEvent.VK_ESCAPE, 7, 7, 0 },
            // Enter + CTRL
            { '\r', 0, 1, 0 },
            // Commodore key on the control keys
            { KeyEvent.VK_CONTROL, 7, 5, KeyEvent.KEY_LOCATION_LEFT }, { KeyEvent.VK_ENTER, 0, 1, 0 },
            // DOWN & RIGHT
            { KeyEvent.VK_DOWN, 0, 7, 0 }, { KeyEvent.VK_UP, 0, 7, AUTO_SHIFT }, { KeyEvent.VK_RIGHT, 0, 2, 0 },
            { KeyEvent.VK_LEFT, 0, 2, AUTO_SHIFT },
            // Function keys
            { KeyEvent.VK_F1, 0, 4, 0 }, { KeyEvent.VK_F3, 0, 5, 0 }, { KeyEvent.VK_F5, 0, 6, 0 },
            { KeyEvent.VK_F7, 0, 3, 0 }, { KeyEvent.VK_HOME, 6, 3, 0 }, { KeyEvent.VK_END, 6, 6, 0 },
            { KeyEvent.VK_INSERT, 6, 0, 0 }, { KeyEvent.VK_TAB, 7, 2, 0 } };
    ...
    private static final int[] ARROWS = new int[] { KeyEvent.VK_UP, 0, KeyEvent.VK_DOWN, 0, KeyEvent.VK_LEFT, 0,
            KeyEvent.VK_RIGHT, 0, KeyEvent.VK_CONTROL, KeyEvent.KEY_LOCATION_RIGHT };
    ...
    private void remap(char key, char newkey) {
        for (int i = 0, n = keytableDef.length; i < n; i++) {
            if (keytableDef[i][0] == key) {
                ...
                System.out.println("Remapped: " + (char) key + " => " + (char) newkey + "  key " + (int) key + " => "
                        + (int) newkey);
                return;
            }
        }
    ...
    public int readDC00(int pc) {
        ...
        // System.out.println("Read keyboard via dc00: => " + ((val & (cia.pra |
        // ~(cia.ddra))) & tmp));
    ...
    public int readDC01(int pc) {
        ...
        // System.out.println("Read keyboard via dc00: " + val + " => " + ((val &
        // (cia.prb | ~(cia.ddrb))) & tmp));
