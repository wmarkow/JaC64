...
public class DKnob2 extends JComponent {
    ...
    public DKnob2(String label, String type) {
        ...
        for (int i = 0, n = 120; i < n; i++) {
            int y = 20 + (int) (0.5 + (Math.sin(i * 3.141592 / 4) * 1.5 + 20) * Math.sin(i * 3.141592 * 2.0 / n));
            int x = 20 + (int) (0.5 + (Math.sin(i * 3.141592 / 4) * 1.5 + 20) * Math.cos(i * 3.141592 * 2.0 / n));
            knob.addPoint(x, y);
        }
    ...
    private void drawKnob(Graphics2D g2d) {
        ...
        if (hasFocus()) {
            ...
            g2d.fill(new Arc2D.Double(0.0, 0.0, 27.0, 27.0, 90.0, 360.0, Arc2D.OPEN));
        }
        g2d.setColor(DARK);
        g2d.fill(new Arc2D.Double(1.0, 1.0, 25.0, 25.0, 90.0, 360.0, Arc2D.OPEN));
        g2d.setColor(DARK_L);
        g2d.fill(new Arc2D.Double(2.0, 2.0, 22.0, 22.0, 90.0, 360.0, Arc2D.OPEN));
        g2d.setColor(LIGHT_D);
        g2d.draw(new Arc2D.Double(3.0, 3.0, 21.0, 21.0, 75.0, 120.0, Arc2D.OPEN));
        g2d.setColor(LIGHT);
        g2d.draw(new Arc2D.Double(4.0, 4.0, 20.0, 20.0, 122.5, 25.0, Arc2D.OPEN));

        g2d.setColor(DARK);
        g2d.fill(new Arc2D.Double(5.0, 5.0, 18.0, 18.0, 90.0, 360.0, Arc2D.OPEN));

        g2d.setColor(DARK_T);
        g2d.fill(new Arc2D.Double(9.0, 9.0, 18.0, 18.0, 90.0, 360.0, Arc2D.OPEN));
        g2d.setColor(DARK_L);
        g2d.fill(new Arc2D.Double(6.0, 6.0, 16.0, 16.0, 90.0, 360.0, Arc2D.OPEN));
        g2d.setColor(DARK_T);
        g2d.draw(new Arc2D.Double(7.0, 7.0, 14.0, 14.0, 270.0, 90.0, Arc2D.OPEN));
        g2d.setColor(LIGHT_D);
        g2d.draw(new Arc2D.Double(7.0, 7.0, 15.0, 15.0, 90.0, 90.0, Arc2D.OPEN));

        g2d.setColor(LIGHT_D);
        g2d.fill(new Arc2D.Double(7.0, 7.0, 14.0, 14.0, 180 * ang / 3.141592 - 60, 120.0, Arc2D.OPEN));
        g2d.setColor(DARK);
        g2d.draw(new Arc2D.Double(6.0, 6.0, 16.0, 16.0, 180 * ang / 3.141592 - 1, 2.0, Arc2D.PIE));

        g2d.setColor(DARK);
        g2d.draw(new Arc2D.Double(5.0, 5.0, 18.0, 18.0, 180 * ang / 3.141592 - 8, 16.0, Arc2D.OPEN));
        g2d.draw(new Arc2D.Double(4.0, 4.0, 20.0, 20.0, 180 * ang / 3.141592 - 4, 8.0, Arc2D.OPEN));

        g2d.scale(0.5, 0.5);
        if (divisor != 0) {
            g2d.drawString("" + (getIntValue() * 1.0 / divisor) + " " + type, 10, 64);
        } else {
